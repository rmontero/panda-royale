...
import { COLOR_MAX_VALUE } from './rules.js';
// Rules per README.md:
...
// Per-color max legal face value — single source of truth in rules.js, imported
// (top of file) so the scorer and the input validator can never drift apart.
// Values above the max are clamped to 0 (dropped) so a forged client can't
